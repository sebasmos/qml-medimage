...
QUBITS="${QUBITS:-4}"
SEED="${SEED:-0}"
MODEL="vit-patch32-gap"
DATA_DIR="/orcd/pool/006/lceli_shared/DATASET/qml-mimic-cxr-embeddings/vit-base-patch32-224-embeddings/20-seeds/seed_${SEED}"
DATA_FILTER="data_type9+gap_embedding"
OUTPUT_DIR="tests/multiseed_vit32gap/${MODEL}/data_type9/q${QUBITS}/seed_${SEED}"
LOG_DIR="tests/multiseed_vit32gap/logs/${MODEL}"
