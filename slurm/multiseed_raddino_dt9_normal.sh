...
SEED="${SEED:-0}"
MODEL="rad-dino"
DATA_DIR="/orcd/pool/006/lceli_shared/DATASET/qml-mimic-cxr-embeddings/rad-dino-embeddings/20-seeds/seed_${SEED}"
DATA_FILTER="data_type9"
OUTPUT_DIR="tests/multiseed_raddino/${MODEL}/data_type9/q${QUBITS}/seed_${SEED}"
LOG_DIR="tests/multiseed_raddino/logs/${MODEL}"
...
echo "=== Multi-seed (#56) — ${MODEL} q${QUBITS} seed_${SEED} ==="
date
